...
export class SettingComponent {
    ...
    pictureUrl: string = "http://www.themenate.net/applicator/dist/assets/images/avatars/thumb-13.jpg";
    coverUrl: string = "http://www.themenate.net/applicator/dist/assets/images/login-3.png";
    selectedCountry: any;
    selectedLanguage: any;
    inputValue?: string;
    inputValue1: string = 'my site';
    inputValue2: string = 'my site';
    inputValue3: string = 'my site';
    inputValue4: string = 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters,as opposed to using'
    ...
    constructor(private fb: FormBuilder, private modalService: NzModalService, private message: NzMessageService,private msg: NzMessageService) {
    }
    ...
    handleChange1(info: { file: NzUploadFile }): void {
        this.getBase644(info.file.originFileObj, (img: string) => {
            this.coverUrl = img;
        });
    }

    handleChange_upload({ file, fileList }: NzUploadChangeParam): void {
